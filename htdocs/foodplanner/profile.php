	...
	<body>
		...
		<div class="square2">
			<div class="row">
				...
				<br>
				<form role="form" method="POST" action="weight.php">
					<div class="signup">
						<label for="date">Date</label>
						<input pattern=".{10,10}" required title="wrong date" type="text" placeholder="yyyy-mm-dd" name="date">
						<label for="weight">Weight</label>
						<input pattern=".{2,4}" required title="2 digit minimum" type="number" name="weight" placeholder="Weight">
						<br><br>
